...
$lang = array_merge($lang, array(
	...
	// ACP
	'ACP_RCE_TITLE'			=>	'Éditeur UCN (par CKEditor)',
	'ACP_RCE_SETTING'		=>	'Paramètres',
	'RCE_CONFIG_UPDATE'		=>	'Paramètres de l’éditeur UCN mis à jour avec succès !',
	'RCE_SETTING_SAVED'		=>	'Les paramètres de l’éditeur ont été enregistrés avec succès !',
	'RCE_LANGUAGE_TITLE'	=>	'Langue de l’éditeur UCN :',
	'RCE_LANGUAGE_DESC'		=>	'Permet de définir la langue de l’éditeur UCN.<br /><strong>Information :</strong> Sélectionner « Default » pour utiliser la langue du navigateur.',
	...
	'RCE_MOBMS_DESC'		=>	'Permet de choisir si l’éditeur UCN est chargé en mode « Source » lorsque la page est consulté depuis un périphérique mobile.',
	'RCE_ENBQUICK_TITLE'	=>	'Réponse rapide & modification rapide :',
	'RCE_ENBQUICK_DESC'		=>	'Permet d’afficher l’éditeur UCN dans la réponse rapide et lors de la modification rapide.<br /><strong>Information :</strong> Pour profiter de l’éditeur UCN dans la modification rapide il est nécessaire d’installer l’extension « <a href="https://www.phpbb.com/customise/db/extension/quickedit">Quick Edit</a> ».',
	...
	'RCE_STYLE_TITLE'		=>	'Sélection du style de l’éditeur UCN :',
	'RCE_STYLE_DESC'		=>	'Permet de sélectionner un habillage pour l’éditeur UCN.',
