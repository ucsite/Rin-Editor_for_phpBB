...
$lang = array_merge($lang, array(
	...
	// ACP
	'ACP_RCE_TITLE'			=>	'UCN Editor (Powered by CKEditor)',
	'ACP_RCE_SETTING'		=>	'Settings related to the UCN Editor',
	'RCE_CONFIG_UPDATE'		=>	'Updated UCN Editor settings',
	'RCE_SETTING_SAVED'		=>	'Settings have been saved successfully!',
	'RCE_LANGUAGE_TITLE'	=>	'Language of UCN Editor',
	'RCE_LANGUAGE_DESC'		=>	'Set here language of UCN Editor.<br /><strong>PS.</strong> Use default if you want editor detect browser language.',
	'RCE_BBCODE_TITLE'		=>	'BBCode choice',
	'RCE_BBCODE_DESC'		=>	'Choose for which BBCode you want change the group permission.',
	...
	'RCE_MOBMS_DESC'		=>	'Set to yes if you want load UCN Editor in Source Mode when using mobile device.',
	'RCE_ENBQUICK_TITLE'	=>	'Show UCN Editor in quick reply and quick edit',
	'RCE_ENBQUICK_DESC'		=>	'Set to yes if you want to show the UCN Editor in quick reply and quick edit.',
	...
	'RCE_STYLE_TITLE'		=>	'Choose Style',
	'RCE_STYLE_DESC'		=>	'Choose for which style you want change the skin of the editor.',
